...
ax.set_title("Gráfico 1 — Requerimentos por Partido (2014–2024)")
...
(FIGS / "G1_requerimentos_por_partido.png").unlink(missing_ok=True)
(FIGS / "G1_requerimentos_por_partido.svg").unlink(missing_ok=True)
plt.savefig(FIGS / "G1_requerimentos_por_partido.png")
plt.savefig(FIGS / "G1_requerimentos_por_partido.svg")
plt.close()

print("\nGráfico salvo em 'figs/G1_requerimentos_por_partido.png'")
